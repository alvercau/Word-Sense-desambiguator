...
if __name__ == '__main__':
    ...
    train_file = 'data/english-train.xml'
    test_file = 'data/english-dev.xml'
    knn_answer = 'output/KNN-English.answer'
    svm_answer = 'output/SVM-English.answer'
    best_answer = 'output/Best-English.answer'
    language = 'english'
